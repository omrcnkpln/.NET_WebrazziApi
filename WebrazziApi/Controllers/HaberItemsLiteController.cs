...
namespace WebrazziApi.Controllers
{
    ...
    [ApiController]
    public class HaberItemsLiteController : ControllerBase
    {
        private readonly HaberContext _context;

        public HaberItemsLiteController(HaberContext context)
        {
            _context = context;
        }

        // GET: api/HaberItemsLite
        [HttpGet]
